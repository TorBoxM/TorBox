...
if [ -f /opt/$appNameLower/data/flutter_assets/assets/clash/TorBoxCore ]; then
    chmod +x /opt/$appNameLower/data/flutter_assets/assets/clash/TorBoxCore
fi
...
if [ -f /opt/%{name}/data/flutter_assets/assets/clash/TorBoxCore ]; then
    chmod +x /opt/%{name}/data/flutter_assets/assets/clash/TorBoxCore
fi
update-desktop-database /usr/share/applications || true
